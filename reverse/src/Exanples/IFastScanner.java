...
public interface IFastScanner extends Closeable {
     ...
     *
     * @return <b>true</b> if one more token is available
    ...
    boolean hasNextIntInLine() throws IOException;

    boolean hasNextLong() throws IOException;

    boolean hasNextLongInLine() throws IOException;
     ...
     */
    void setWordPredicate(Pattern regexpPattern);
